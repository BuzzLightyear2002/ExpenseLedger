    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark " >
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-1">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="achieve.php" >Achievements</a>
              </li>
              <li class="nav-item">
      ...
      <main >
        <form class="box" action="stats.php" method="post" >
          ...
          <tr><th>PLAYER_ID</th><th>Achievement</th> <th>DETAILS</th></tr>
        <?php
       //  include 'login.php';
        $conn=oci_connect("raj","raj","localhost/xe"); 
        $player_id=$_SESSION['player_id'];
        $sql_run="SELECT * FROM achievement where player_id= $player_id order by player_id";
        $select = oci_parse($conn, $sql_run);
        oci_execute($select);
