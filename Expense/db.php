        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-1">
              ...
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="db.php" target="_blank">Cash Account</a>
              </li>
...
?>
      <main>
        ...
        <form class="box" action="db.php" method="post" >
          <h3 class="h4 mb-2  fw-bold">Cash Account</h3>
          <h3 class="h4 mb-2  fw-bold">Enter your data</h3>
          
          <label for="cars">Choose a Category:</label>
          <select  name="option1" class=" mb-4 form-floating" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Enter your Category"style="border: 2px solid #433d3c;border-radius: 6px;"name="cars" id="cars">
        ...
        if(isset($_POST['submit']))
        {
            if(($_POST['credit'])!=null and $_POST['desc']!=null and $_POST['debit']!=null){
              ...
              $player_id=1;
                ...
                $desc = $_POST['desc'];
                $debit = $_POST['debit'];
                $sql_run = 'begin :output:=entryno(:input1); end;';
                                           $stid1 = oci_parse($conn, $sql_run);
                                           oci_bind_by_name($stid1, ":input1", $player_id);
                                           oci_bind_by_name($stid1, ":output", $id,40);
                                           oci_execute($stid1);
                $sql_insert = "INSERT INTO cash VALUES (sysdate,$id+1,'$category' ,'$desc',$debit,$credit)";
